...
# NOTE: A8c's checks (VTUAD manifest + loader) were removed 2026-08-27. They
# asserted a manifest for a corpus this project no longer acquires, so they were
# permanently red and broke the deterministic gate for everyone. What they
# asserted is recorded in commit 070e3c5 and in docs/decisions/0009.
